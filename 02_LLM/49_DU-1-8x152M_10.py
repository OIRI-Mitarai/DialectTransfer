...
model_name = "llm-jp/DU-1.0-8x152M"
output_dir = "./finetuned_DU-1.0-8x152M_10"
num_train_epochs = 10
    ...
    with torch.no_grad():
        gen_ids = model.generate(
            **inputs,
            ...
            output_router_logits=False,   # MoEで必須
            use_cache=True                # これもMoEで重要
        )

    gen_text = tokenizer.decode(gen_ids[0], skip_special_tokens=True)

    # 抽出処理
    standard = gen_text.split("標準語:")[-1].strip()
